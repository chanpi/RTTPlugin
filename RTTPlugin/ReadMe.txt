========================================================================
    Win32 アプリケーション: RTTPlugin プロジェクトの概要
========================================================================

この RTTPlugin アプリケーションは、AppWizard により作成されました。
...
RTTPlugin.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル RTTPlugin.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル RTTPlugin.rc 
    にインクルードされます。
